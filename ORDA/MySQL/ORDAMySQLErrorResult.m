...
- (id)initWithCode:(ORDAMySQLResultCodeError)code andMySQL:(MYSQL *)connection
{
	...
	if (!connection)
		return (ORDAMySQLErrorResult *)[ORDAMySQLErrorResult errorWithCode:kORDANilConnectionErrorResultCode].retain;
	...
	if (self.error_status.length < 1)
		return (ORDAMySQLErrorResult *)[ORDAMySQLErrorResult errorWithCode:kORDASucessResultCode].retain;
